...
- `glyphs/generated/velvet_leather/Velvet and Leather Pictograph Atlas v2.svg` - production pictograph replacement authored as true transparent vector art after the illustrated atlas proved visually off-center and developed pale matte fringes at board size. Five optically centered, flat oxblood-and-aged-gold emblems occupy exact 512x512 cells; the final cell is empty. This atlas deliberately bypasses the legacy matte-removal shader.
